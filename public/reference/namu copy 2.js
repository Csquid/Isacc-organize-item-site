...
// divideArray[0][1].children[1].children[0].children[0].children[0].children[0].children[1]
    ...
    isaac_datas_obj[nData_id].place         = divideArray[i][5].children[1].children[0].innerText.replace(/\n/g, "").split(", ");
    isaac_datas_obj[nData_id].description   = divideArray[i][6].children[1].children[0].textContent.split(".");
