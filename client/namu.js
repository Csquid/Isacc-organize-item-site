...
let searchData = isaac_version.EXPANSING_PACK;
let httpCollection = document.querySelectorAll(".wiki-heading-content")[searchData].children[0].children[0].children[0].children
